...
## AIM:
To write a program to implement the Logistic Regression Model to predict the Placement Status of a student.
...
## Algorithm
1. Load the dataset, drop NaN columns, and encode categorical variables.
...
```
/*
Program to implement the Logistic Regression Model to Predict the Placement Status of a Student.
